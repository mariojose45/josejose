...
{ 
    ...
    public function insertar($idusuario_salida,$descripcion_salida_product,$datosArticulos)
    {
        date_default_timezone_set('America/Guatemala');
        $fechaHora = date('Y-m-d H:i:s');

        $sql="INSERT INTO venta_salida (idusuario,fecha_hora,observacion_credito,idusuario_creacion,idsucursal)
        VALUES ('$idusuario_salida',NOW(),'$descripcion_salida_product','".$_SESSION["idusuario"]."','".$_SESSION["idsucursal"]."')";
        ...
        if($idtraladosucursalnew){
            ...
            for ($i = 0; $i < $numArticulos; $i++){
                ...
                cantidad_ventas_salidas,fecha_horaCreacion,idarticulo,idusuario,idsucursal) 
                VALUES ('$idtraladosucursalnew','$totalcantidadpresentacion','$fechaHora','$idarticulo','".$_SESSION["idusuario"]."','".$_SESSION["idsucursal"]."')";
    ...
    public function editarSalida($idtraladosucursal,$idsucursal,$fecha_hora,$descripcion_salida_producto,$idusuario,$idsucursalorigen,
    ...
    public function anular($idventa_salida)
    {
        ...
        $sqlDetalleIngresoElimminar="DELETE from operaciones_compras_ventas where idventa_salida=".$idventa_salida."";
        ejecutarConsulta($sqlDetalleIngresoElimminar);
