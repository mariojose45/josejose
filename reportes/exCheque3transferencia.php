<?php
 ...
 else
 {
   if ($_SESSION['ventas']==1)
   {
    ...
    $email = "mdeleon@tecnoserviciosjireh.com";
     ...
     $pdf->SetXY(25,50);
     $pdf->Cell(40,10,'TRANSFERENCIA');    
     $pdf->Cell(50,10,'------------------------'); 
     $pdf->Cell(10,10,'TRANSFERENCIA');                
 ...
 //////////////////////datos de horas 
     ...
     $pdf->SetXY(100,175);    
     $pdf->Cell(10,10,'Total Sin Descuento Q:'); 
     $pdf->SetXY(140,175);
     $pdf->Cell(10,10,$reg->totalsindescuento,0);  

     $pdf->SetXY(155,175);    
     $pdf->Cell(10,10,'Des Q:'); 
     $pdf->SetXY(165,175);
     $pdf->Cell(10,10,$reg->descuento,0);          
     ...
     $pdf->Cell(10,10,'*************************************************************************************************************************************');                  
    $pdf->SetXY(75,195);    
    $pdf->Cell(10,10,'..::Detalle de rango de rango de horas a pagar::..'); 
    $pdf->SetXY(10,200); 
    $pdf->SetFont('helvetica','',8);
    $rsptad = $pagoempleado->pagocabecerDetalle($_GET["id"]);
    //$res=;
    $ii=0;
    while($regdv =$rsptad->fetch_object()){
      ...
      $pdf->Cell(10,10,'');
      $pdf->Cell(10,10,$regdv->codigo,0);
      $pdf->Cell(30,10,$regdv->fecha,0); 
      $pdf->Cell(23,10,$tipoe,0);  
      if($ii==1){
         $pdf->Ln(2);
         $pdf->Ln(2);
         $ii=-1;
    ...
    $pdf->Cell(10,10,'Firma Colaborador:_______________________:');  
    $pdf->Cell(75,10,'');    
    $pdf->Cell(10,10,'Firma Patrono:_______________________:');         
    ...
    $pdf->Ln(2);     
    $pdf->Cell(75,10,'');     
    $pdf->Cell(10,10,'..::Comprobante de colaborador::..');     
    $pdf->Ln(2); 
    $pdf->Ln(2);   
    $pdf->Cell(10,10,'fecha Creacion Cheque: ');  
    $pdf->Cell(30,10,'');      
