...
function addClientAdresse( $cliente,$email,$telefono )
{
    ...
    $this->SetXY( $r1, $y1);
    $this->SetFont( "Arial", "B", 10);
    $this->MultiCell( 60, 4, "Datos Facturacion:");
    $this->SetXY( $r1, $y1+5);
    $this->SetFont( "Arial", "", 10);
...
function addCols( $tab )
{
    ...
    $r2  = $this->w - ($r1 * 2) ;
    $y1  = 65;
    $y2  = $this->h - 65 - $y1;//en esta linea hago mas pequño el area de las columnas
    $this->SetXY( $r1, $y1 );
...
function addCadreEurosFrancs($impuesto)
{
    ...
    $this->SetXY( $r1, $y1+2 );
    $this->Cell(20,4, "FORMA PAGO", 0, 0, "C");

    $this->SetXY( $r1, $y1+6 );
    $this->Cell(20,4, "EFECTIVO", 0, 0, "C");

    $this->SetXY( $r1, $y1+10 );
    $this->Cell(20,4, "TARJETA", 0, 0, "C");    
