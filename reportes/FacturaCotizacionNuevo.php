...
function addDate( $date )
{
    ...
    $this->Cell(10,5, "Fecha Cotizacion", 0, 0, "C");
...
// Client address
function addClientAdresse( $cliente,$direccion,$telefono,$domicilio,$num_documento )
{
    $r1     = $this->w - 200;
    $r2     = $r1 + 1;
    $y1     = 50;
...
function addCols( $tab )
{
    ...
    $r2  = $this->w - ($r1 * 2) ;
    $y1  = 79;
    $y2  = $this->h - 81 - $y1;//en esta linea hago mas pequño el area de las columnas
    $this->SetXY( $r1, $y1 );
