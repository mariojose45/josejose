...
<table border="0" align="center" width="300px">
    ...
    <tr>
        <td align="center"><strong> NOTA CREDITO </strong></td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="center"> <?php echo date("d/m/Y", strtotime($reg->fecha_hora_nc)); ?></td>
    </tr>
    <tr>
      <td align="center" colspan="4">==========================================</td>
    </tr>             
...
<table border="0" align="center" width="300px">
    ...
    <tr>
        <td colspan="4" align="center">NUMERO DE AUTORIZACION:</td>
    </tr>    
    <tr>
        <td colspan="4" align="center"> <?php echo $reg->autorizacionEcoFactura_venta; ?></td>
    </tr> 
    
    <tr>
        <td colspan="4" align="center">NUMERO: <?php echo $reg->numero_ecoFactura_venta; ?></td>

    </tr>    

    <tr>
        <td colspan="4" align="center">SERIE: <?php echo $reg->serie_comprobante_venta; ?></td>

    </tr> 
   
    <tr>
        <td colspan="4" align="center">Fecha Emision Venta:</td>
    </tr> 
    <tr>
        <td colspan="4" align="center"> <?php echo date("d/m/Y", strtotime($reg->fechaVenta)); ?></td>
    </tr>
    ...
    <tr>
        <td colspan="4" align="center">IDVENTA: <?php echo $reg->idventa; ?></td>
    </tr>    
