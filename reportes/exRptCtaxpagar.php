...
else
{
  if ($_SESSION['ventas']==1)
  {
    ...
    $rsptav = $cuentasporpagar->ctasxpagar($_GET["id"]); 
    ...
    $pdf->SetXY(10,20);
    $pdf->Cell(10,10,$reg->sucursal_nombre);  
    $pdf->SetXY(10,25);
    $pdf->Cell(10,10,$reg->sucursal_nit);   
    $pdf->SetXY(10,30);
    $pdf->Cell(10,10,$reg->sucursal_direccion);  
    $pdf->SetXY(10,35);
    ...
    $pdf->Image($url.$reg->sucursal_imagen,120,10,75,25);
