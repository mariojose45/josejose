...
//$pdf->addSociete($logo,$ext_logo);
    ...
    $pdf->fact_dev( utf8_decode("ENVIO NOTA CREDITO"),"" );
    $pdf->temporaire( "" ); 
...
//$pdf->Rect(10,43, 100, 4, 'F'); //Rectángulo relleno y con liena
    ...
    $pdf->Ln(1);
    $pdf->SetX($xposision); 
    $pdf->Multicell($ancchodefial,4,utf8_decode("Fecha Emision: ".$regv->usuarioNc),0,"C"); 
    ...
    $pdf->Ln(5);
    $pdf->SetX($xposision);     
    $pdf->Multicell($ancchodefial,4,utf8_decode("Le atendio: ".$regv->usuarioNc),0,"C");   
    ...
    $pdf->Ln(5);
    $pdf->SetX($xposision);     
    $pdf->Multicell($ancchodefial,4,utf8_decode("Nº de idVenta control interno ".$regv->idventa),0,"C");    

    $pdf->Ln(5);
    $pdf->SetX($xposision);     
    $pdf->Multicell($ancchodefial,4,utf8_decode("Fecha Venta ".$regv->fechaVenta),0,"C");      
    ...
    $pdf->Output('Envio NC No '.$regv->idnota_credito.".pdf",'I');
