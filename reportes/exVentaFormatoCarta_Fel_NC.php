...
/////PARTE DE ABAJO            
            ...
            $pdf->temporaire( "" ); 
            $pdf->addDate($regv->serie_ecoFactura,$regv->numero_ecoFactura,$regv->fechaCertificacion_ecoFactura,$regv->autorizacionEcoFactura,$regv->fecha_hora_nc);
            $pdf->SetXY(110,1); 
        ...
        //$pdf->Rect(10,43, 100, 4, 'F'); //Rectángulo relleno y con liena
            ...
            $pdf->SetXY(10,35); 
            $pdf->Multicell(140,4,"Tels: ".$regv->sucursal_telefono."  Email: ".$regv->sucursal_email,0,"L");  
            $pdf->Ln(1);
            $pdf->SetX(10);               
            ...
            $pdf->addRectangulo1();  
            $pdf->SetXY(10,30);
            $pdf->Cell(95,4,utf8_decode("User Crea: ".$regv->usuarioNc),0,"L"); 
            $pdf->SetXY(10,39);
...
//function addDate( $serie,$numero,$fechafac,$numAutorizacion,$fecha )
    ...
    $pdf->SetTextColor(0,0,0); 
     $cantidad=0;
        ...
        $pdf->Ln(5);
        $pdf->SetX(10);     
        $pdf->Cell(63,4,utf8_decode("DOCUMENTOS DE REFERENCIA VENTA:  "),0,0,"L");   $pdf->Cell(95,4,utf8_decode("# DE AUTO:  ".$regv->autorizacionEcoFactura_venta),0,0,"L"); 
        $pdf->Ln(3);
        $pdf->SetX(10);     
        $pdf->Cell(63,4,utf8_decode("SERIE: ".$regv->serie_comprobante_venta),0,0,"L"); $pdf->Cell(63,4,utf8_decode("NUMERO: ".$regv->numero_ecoFactura_venta),0,0,"L"); $pdf->Cell(63,4,utf8_decode("FECHA-EMISION VENTA: ".date("d/m/Y", strtotime($regv->fechaVenta))),0,0,"L");
        $pdf->Ln(3);
        $pdf->SetX(10);     
        $pdf->Cell(190,4,utf8_decode("MOVITVO NC: ".$regv->motivo_nc),0,0,"L"); 
        $pdf->Ln(3);
        $pdf->SetX(10);     
        $pdf->Cell(190,4,utf8_decode("IDVENTA:  ".$regv->idventa),0,0,"L");          
