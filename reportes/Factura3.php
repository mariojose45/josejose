...
// Company
function addSociete($logo,$ext_logo )
{
    $x1 = 150;
    $y1 = 40;
    //Positionnement en bas
    $this->Image($logo , 110 ,3, 180 , 30 , $ext_logo);

}

// Company
function addSocieted($logo,$ext_logo )
{
    $x1 = 10;
    $y1 = 40;
    //Positionnement en bas
...
function addClientAdresse( $cliente,$email,$telefono )
{
    ...
    $this->SetXY( $r1, $y1);
    $this->SetFont( "Arial", "B", 10);
    $this->MultiCell( 100, 4, "CLIENTE:");
    $this->SetXY( $r1+20, $y1);
    $this->SetFont( "Arial", "", 10);
    $this->MultiCell( 300, 4, $cliente);
    //$this->SetXY( $r1, $y1+10);
    ...
    $this->MultiCell( 100, 4, "DIRECCION:");    
    $this->SetXY( $r1, $y1+10);
    $this->MultiCell( 300, 4, $email);
    $this->SetXY( $r1 , $y1+15);
    $this->MultiCell( 300, 4, $telefono);
}
...
function addCols( $tab )
{
    ...
    $r2  = $this->w - ($r1 * 2) ;
    $y1  = 79;
    $y2  = $this->h - 90 - $y1;//en esta linea hago mas pequño el area de las columnas
    $this->SetXY( $r1, $y1 );
