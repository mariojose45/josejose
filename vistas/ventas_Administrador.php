                        ...
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                              ...
                              <input type="text" class="form-control" name="observacion_credito" id="observacion_credito" maxlength="250">
                            </div> 
                            <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <label>Vendedor(*):</label>

                              <input type="text" class="form-control" name="nombre_vendedor" id="nombre_vendedor" maxlength="250">
                            </div> 
                                ...
                                <div class="modal-body">
                                    <table>
                                      ...
                                      <tr>
                                        ...
                                        <td ><h1><input type="number" id="cefectivo" name="cefectivo" step="0.1" class="form-control"></h1>
                                      ...
                                      <tr>
                                        <td><h1>CAMBIOS: </h1></td>
                                        <td >
                                          <h1 id="cambio"><input type="text" name="rescambio" id="rescambio" ></h1>
                                        </td>
                                      </tr>
                                    </table>  
                                </div>
