              ...
              <div class="col-md-12">
                  <div class="box">
                        <div class=" with-border box box-primary">
                          ...
                          <h1>
                          Cobros   
                          <small>Reporte de Ventas x  Sucursal</small>
                          </h1>
                          <ol class="breadcrumb">
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros" style="height: 800px;">
                        ...
                        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover"> 
                          <thead>
                            ...
                            <th>Propina</th>
                            <th>Mesero</th>
                            <th>Venta F/Creacion</th>
                            <th>Orden F/Creacion</th>
                            <th>Estado</th>
                          </thead>
                          <tbody>                            
                          </tbody>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/ventasxfecharestaurante.js"></script>
<?php 
}
ob_end_flush();
?>