...
if (!isset($_SESSION["nombre"]))
  ...
  {
  require 'header.php';
  if ($_SESSION['acceso_mensajeros']==1) 
  {
                    ...
                    <div class="panel-body" style="height: 500px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <label>Nombre:</label>
                            <input type="hidden" name="idmensajero" id="idmensajero">
...
<script type="text/javascript" src="scripts/mensajero.js"></script>  
