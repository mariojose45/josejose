                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="saldo_cuenta" id="saldo_cuenta" maxlength="256" readonly="">
                          </div> 
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="nombre_agencia" id="nombre_agencia" maxlength="256" placeholder="Nombre Agencia">
                          </div>                                                                               
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <label>Deposito No:</label>
                            <input type="text" class="form-control" name="deposito_no" id="deposito_no" maxlength="256" placeholder="Deposito No">
                          </div> 
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <label>Valor Deposito No:</label>
                            <input type="number" step="any" class="form-control" name="valor_deposito" id="valor_deposito" maxlength="40" placeholder="00.00">
                          </div>                           
