...
if (!isset($_SESSION["nombre"])) {
    ...
    if ($_SESSION['consulta_compras_detallado'] == 1) {
?> 
                  ...
                  <div class="box">
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros" style="height: 1000px;">
                        ...
                        <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <button class="btn btn-success" onclick="listarxsucursalDetalle()">Mostrar x fecha y sucursal</button>                          
                        </div>                          
