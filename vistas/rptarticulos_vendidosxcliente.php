              ...
              <div class="col-md-12">
                  <div class="box">
                        <div class=" with-border box box-primary">
                          ...
                          <h1>
                          Articulos mas Vendidos x Cliente
                          <small>Ventas</small>
                          </h1>
                          <ol class="breadcrumb">
                          <li><a href="escritorio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
                          <li class="active">Articulos mas Vendidos x Cliente</li>
                          </ol>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/rptarticulos_vendidosxcliente.js"></script>  
<?php 
}
ob_end_flush();
?>