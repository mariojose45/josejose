...
if (!isset($_SESSION["nombre"]))
  ...
  {
  require 'header.php';
  if ($_SESSION['ventas_mensajero_transporte']==1)   
  {
              ...
              <div class="col-md-12">    
                  <div class="box">
                        <div class=" with-border box box-primary">
                          ...
                          <h1>
                          Ventas  
                          <small>Ventas Mensajeros/Transporte</small>
                          </h1>
                          <ol class="breadcrumb">
                          <li><a href="escritorio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
                          <li class="active">Ventas Mensajeros/Transporte</li>
                          </ol>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                      <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="box-header with-border">
                          <h3 class="box-title">Ventas Mensajeros/Transporte</h3>
...
<div class="modal fade" id="agregarComentarioMensajeroTransporte" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog" style="width: 40% !important;">
      <div class="modal-content">

        <div class="modal-body">
          <form name="formulario_comentarioMensajeroTransporte" id="formulario_comentarioMensajeroTransporte" method="POST">
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <label>Ingrese la Referencia completa para la entrega de tu pedido :</label>
                <input type="hidden" name="idventa_MensajeroTransporte" id="idventa_MensajeroTransporte">
                <textarea class="form-control" name="comentario_mensajero_transporte" id="comentario_mensajero_transporte" rows="5" cols="50"></textarea>
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <label>Guia o Codigo Transporte:</label>
              <input type="text" class="form-control" name="guia_transporte" id="guia_transporte" maxlength="100" value="0">
            </div>            
          </form>    
        </div> 
        <div class="modal-footer">
          <button class="btn btn-primary" type="button" id="btnGuardarComentariosMensajeroTransporte"><i class="fa fa-save"></i> Guardar Transporte</button>
          <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button> 
