    ...
    <div class="modal-dialog" style="width: 95% !important;">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <button class="btn btn-success btn-block" onclick="listarVentaxlote()" type="button"><i class="fa fa-gears"></i> Ver Facturas</button>
          </div>
          <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12"> 
          ...
          <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
            ...
            <font color="Red" ><h1 id="totalAbonoGeneral">Q/. 0.00</h1></font>                         
          </div>   
          <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <label><img class="iconos-cambio" src="../public/iconos/efectivo.png">Total Saldo Pendiente x Pagar:</label>
            <font color="Red" ><h1 id="totalSaldoGeneral">Q/. 0.00</h1></font>                         
          </div>                     
          
        </div>
        <div class="modal-body">
         <div class="col-lg-6 col-sm-6 col-md-12 col-xs-12 table-responsive">
