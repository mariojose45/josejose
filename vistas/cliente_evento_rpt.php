                  ...
                  <div class="box">
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        ...
                        <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <button class="btn btn-success btn-block" onclick="listar_evento()">Reporte x cliente</button>
                          <button class="btn btn-success btn-block" onclick="listar_eventoxrango()">Reporte x rango de fechas</button>
                        </div>
                        <table id="tbllistado_evento" class="table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            <th>Titulo</th>
                            <th>Descripción</th>
                            <th>Fecha</th>
