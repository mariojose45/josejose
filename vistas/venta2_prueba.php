                            ...
                            <div class="panel-body" style="height: 800px;" id="formularioregistros">
                                ...
                                <form name="formulario" id="formulario" method="POST">
                                    ...
                                    <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12" style="display: none;">
                                            <label>Fecha(*):</label>
                                        ...
                                        <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <button class="btn btn-primary w-100" id="btnProcesar" type="button"
                                                        data-toggle="modal" href="#myModal23">
                                                        <i class="fa fa-save"></i> Procesar
                                                    </button>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <button id="btnCancelar" class="btn btn-danger w-100"
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: none;">
                                            <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                <input type="text" class="form-control" name="codigo_ingresar"
                                                    id="codigo_ingresar" maxlength="50" placeholder="codigo">
                                            </div>
                                            <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                <input type="hidden" name="idarticulo_ingreso" id="idarticulo_ingreso"><input
                                                    type="text" class="form-control" name="articulo_ingresar"
                                                    id="articulo_ingresar" readonly="">
                                            </div>
                                            <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                <input class="form-control" type="number" step="any" name="cantidad_ingreso"
                                                    id="cantidad_ingreso">
                                            </div>
                                            <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                <input class="form-control" type="number" step="any" name="precio_venta_ingreso"
                                                    id="precio_venta_ingreso" readonly="">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel-body table-responsive contenedor-articulos-scroll">
                                                        <div id="listadoregistros2">
                                                            <div class="col-12 text-center text-muted">Cargando artículos,
                                                                espere...</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="box box-success box-solid collapsed-box">
                                                                ...
                                                                <div class="box-body" style="display: none;">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <label>Q Abono(*):</label>
                                                                        <input type="number" class="form-control"
                                                                            name="monto_abono" id="monto_abono">
                                                                    </div>
                        ...
                        <div class="col-lg-812 col-sm-12 col-md-812 col-xs-12 table-responsive">
                            <form name="formulariocierre" id="formulariocierre" method="POST">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" name="total_efectivo_inicio"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table id="tbllistadoxsucursalxarticulo"
                            class="table table-striped table-bordered table-condensed table-hover">
                            <thead>
                                <th>Sucursal</th>
                                <th>Nombre</th>
