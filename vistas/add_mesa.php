                  ...
                  <div class="box">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <a data-toggle="modal" href="#myModalVentasxlote">           
                            <button id="btnAgregarArt " type="button" class="btn btn-primary btn-block" onclick="mostrarform(true)"> <span class="fa fa-plus "></span> Creacion de Mesas</button>
                          </a>
                        </div> 
                    <!-- /.box-header -->
                    <!-- centro -->
...
<script type="text/javascript" src="scripts/add_mesa.js"></script> 
