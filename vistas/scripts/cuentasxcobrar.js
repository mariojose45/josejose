...
function listar()
{
    tabla=$('#tbllistado').dataTable(
    {
        ...
        "ajax":
                {
                    url: '../ajax/cuentasxcobrar.php?op=listar',
                    type : "get",
                    dataType : "json",                      
                    error: function(e){
...
function guardaryeditar(e)
{
    ...
    $.ajax({
        url: "../ajax/cuentasxcobrar.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
{
    $.post("../ajax/cuentasxcobrar.php?op=mostrar",{idventa : idventa}, function(data, status)
    {
