...
function init() {
    ...
    //cobradores
    $.post("../ajax/venta.php?op=selectCobradores", function (r) {
        $("#idcobradores").html(r);
        $('#idcobradores').selectpicker('refresh');
    });
    //tecnicos
    $.post("../ajax/venta.php?op=selectTecnicos", function (r) {
        $("#idtecnico").html(r);
    ...
    tabla = $('#tbllistado').dataTable(
        {
            ...
            "ajax":
            {
                url: '../ajax/venta.php?op=listar_ventas_servicios',
                data: { fecha_inicio_reporte: fecha_inicio_reporte, fecha_fin_reporte: fecha_fin_reporte },
                type: "get",
                dataType: "json",
                error: function (e) {
