...
function calculoar() {
    ...
    var repuestos = $("#repuestos").val();
    var anticipo = $("#anticipo").val();

    var res = parseFloat(presupuesto) - (parseFloat(repuestos) + parseFloat(anticipo));
    $("#total_orden").val(res);
...
function guardaryeditarMarca(e) {
    ...
    $.ajax({
        url: "../ajax/marca.php?op=guardaryeditarModal",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
    ...
    tabla = $('#tbllistado').dataTable(
        {
            ...
            "ajax":
            {
                url: '../ajax/admin_ordenes.php?op=listar',
                type: "get",
                dataType: "json",
                error: function (e) {
...
/*
    ...
    Total/Orden
*/
//Inicializacion de la tabla SOLO UNA VEZ
    ...
    tabla = $('#tblarticulosequiposreparados').dataTable(
        {
            ...
            "ajax":
            {
                url: '../ajax/admin_ordenes.php?op=ordenesxcliente_reparacion',
    ...
    tabla = $('#tblarticulosequiposEspera').dataTable(
        {
            ...
            "ajax":
            {
                url: '../ajax/admin_ordenes.php?op=ordenesxcliente_espera',
    ...
    tabla = $('#tblarticulosequiposEntregados').dataTable(
        {
            ...
            "ajax":
            {
                url: '../ajax/admin_ordenes.php?op=ordenesxcliente_entregados',
    ...
    tabla = $('#tblarticulosequiposGarantia').dataTable(
        {
            ...
            "ajax":
            {
                url: '../ajax/admin_ordenes.php?op=ordenesxcliente_garantia',
    ...
    tabla = $('#tblarticulosequiposSinreparar').dataTable(
        {
            ...
            "ajax":
            {
                url: '../ajax/admin_ordenes.php?op=ordenesxcliente_SINREPARAR',
    ...
    tabla = $('#tblarticulosequiposReparadoss').dataTable(
        {
            ...
            "ajax":
            {
                url: '../ajax/admin_ordenes.php?op=ordenesxcliente_REPADOSS',
