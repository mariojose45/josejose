              ...
              <div class="col-md-12">
                  <div class="box">
                        <div class="callout callout-info">
                          <h4>Modulo de horarios Produccion!</h4>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <label>Hora 1:</label>
                            <input type="hidden" name="idhora_produccion" id="idhora_produccion">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/horarios_produccion.js"></script> 
