...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['compras_ingresos'] == 1) {
?>
    <!--Contenido-->
              ...
              <div class="panel-body" style="height: 1000px;" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <label>Consulta de Precios por Proveedor:</label>
                      <a data-toggle="modal" href="#myModalProveedor">
                        <button id="btnAgregarArt" name="btnAgregarArt" type="button" class="btn btn-info btn-block"> <span class="fa fa-eye"></span>Consultar</button>
                      </a>
                    </div>

                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <label>Cargar Orden de Compra:</label>
    ...
    <!-- MODAL PARA CONSULTAR PRECIOS POR PROVEEDOR INICIO -->
    <div class="modal fade" id="myModalProveedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog" style="width: 80% !important;">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title">Consulta de Precios Por Proveedor</h4>
          </div>
          <div class="modal-body" style="width: 0px;width: -webkit-fill-available;">
            <table id="tblarticulos_xproveedor" class="table table-striped table-bordered table-condensed table-hover" style="width: 0px;width: -webkit-fill-available;">
              <thead>
                <th>Fecha</th>
                <th>Código</th>
                <th>Nombre</th>
