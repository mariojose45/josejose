                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" style="height: 800px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            <label>Empresa a quien dirije Cotizacion:</label>
                            <input type="text" class="form-control" name="nombre_empresa" id="nombre_empresa" maxlength="256">
                          </div> 
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>Telefono Empresa:</label>
                            <input type="text" class="form-control" name="telefono_empresa" id="telefono_empresa" maxlength="256">
                          </div>                                                                             

                          <div class="form-group col-lg-10 col-md-10 col-sm-10 col-xs-12">
                            <label>Busqueda Codigo de Barra:</label>
                            <input type="text" id="txtbusquedaartcodebar" class="form-control" autofocus="autofocus" placeholder="Click para Gestionar las lecturas con pistola">
                          </div> 
                            ...
                            <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                              <thead style="background-color:#A9D0F5">
                                ...
                                <tfoot>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th><font color="Red" ><h1 id="total">Q/. 0.00</h1></font><input type="hidden" name="total_venta" id="total_venta" ></th>
