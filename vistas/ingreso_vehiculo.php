            ...
            <div class="row">   
              <div class="col-md-12"> 
                  <div class="box">
                    ...
                    <div class="panel-body" style="height: 1600px;" id="formularioregistros">
                        ...
                        <form name="formulario" id="formulario" method="POST">
                            ...
                            <!-- DATOS IMAGENES -->
                            <b style="display: wrap; justify-content:center">Estado del Vehiculo General:</b>
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <textarea name="trabajos_detalle" id="trabajos_detalle" rows="3" class="form-input-text" placeholder="Descripción de los trabajos a realizar..."></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="observaciones_adicionales" class="form-label">Observaciones:</label>
                                            <textarea name="observaciones_adicionales" id="observaciones_adicionales" rows="3" class="form-input-text" placeholder="Observaciones adicionales..."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12" style="display:none">
                                <div class="form-container-check">
                                    ...
                                    <div class="form-row-check">
                                        <div class="form-item-check">
                                            <div class="item-content-check">
                                                <img src="../files/articulos/bateria.png" alt="Luz de batería" class="item-icon-check">
                                                <span class="item-text-check">Luz de advertencia de la batería</span>
                                            </div>
                                            <label class="switch-check">
                                                <input type="checkbox" name="check_bateria" id="check_bateria" value="Si">
                                        ...
                                        <div class="form-item-check">
                                            <div class="item-content-check">
                                                <img src="../files/articulos/traccion.png" alt="Luz de control de tracción" class="item-icon-check">
                                                <span class="item-text-check">Luz de control de tracción</span>
                                            </div>
                                            <label class="switch-check">
                                                <input type="checkbox" name="check_tcs" id="check_tcs" value="Si">
                                                <span class="slider-check"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-item-check">
                                            <div class="item-content-check">
                                                <img src="../files/articulos/falla motor.png" alt="Luz de motor" class="item-icon-check">
                                                <span class="item-text-check">Luz de advertencia del motor</span>
                                            </div>
                                            <label class="switch-check">
                                                <input type="checkbox" name="check_motor" id="check_motor" value="Si">
                                                <span class="slider-check"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row-check">
                                        <div class="form-item-check">
                                            <div class="item-content-check">
                                                <img src="../files/articulos/aceite.png" alt="Luz de presión de aceite" class="item-icon-check">
                                                <span class="item-text-check">Luz de advertencia de presión de aceite</span>
                                            </div>
                                            <label class="switch-check">
                                                <input type="checkbox" name="check_aceite" id="check_aceite" value="Si">
                                                <span class="slider-check"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-item-check">
                                            <div class="item-content-check">
                                                <img src="../files/articulos/bolsas aire.png" alt="Luz de airbag" class="item-icon-check">
                                                <span class="item-text-check">Luz de advertencia del airbag (SRS)</span>
                                            </div>
                                            <label class="switch-check">
                                                <input type="checkbox" name="check_airbag" id="check_airbag" value="Si">
                                                <span class="slider-check"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-item-check">
                                            <div class="item-content-check">
                                                <img src="../files/articulos/presioma llantas.png" alt="Luz de neumáticos" class="item-icon-check">
                                                <span class="item-text-check">Luz de advertencia de neumáticos</span>
                                            </div>
                                            <label class="switch-check">
                                                <input type="checkbox" name="check_tpms" id="check_tpms" value="Si">
                                                <span class="slider-check"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row-check">
                                        <div class="form-item-check">
                                            <div class="item-content-check">
                                                <img src="../files/articulos/abs.png" alt="Luz de frenos ABS" class="item-icon-check">
                                                <span class="item-text-check">Luz de advertencia del sistema de frenos antibloqueo (ABS)</span>
                                            </div>
                                            <label class="switch-check">
                                                <input type="checkbox" name="check_abs" id="check_abs" value="Si">
                                                <span class="slider-check"></span>
                                            </label>
                                        </div>
                                    </div>
...
<script type="text/javascript" src="scripts/ingreso_vehiculo.js"></script>
<style>
    ...
    <style>
        ...
        .form-container-imagenesData {
            ...
            width: 100%;
            display: grid;
            grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); /* 3 columnas en pantallas grandes, se ajusta */
            gap: 25px;
        }
