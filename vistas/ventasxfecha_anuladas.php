...
if ($_SESSION['consulta_ventas_anuladas']==1)
{
?> 
<!--Contenido--> 
              ...
              <div class="col-md-12">
                  <div class="box">
                        <div class=" with-border box box-primary">
                          ...
                          <h1>
                          Ventas  Anuladas
                          <small>Reporte de Ventas, Sucursal</small>
                          </h1>
                          <ol class="breadcrumb">
                          <li><a href="escritorio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
                          <li class="active">Ventas  Anuladas</li>
                          </ol>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/ventasxfecha_anuladas.js"></script>
<?php 
}
ob_end_flush();
?>