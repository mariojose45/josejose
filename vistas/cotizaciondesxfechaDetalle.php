              ...
              <div class="col-md-12"> 
                  <div class="box"> 
                        <div class=" with-border box box-primary">
                          ...
                          <h1>
                          Cotizaciones  
                          <small>Reporte de Cotizaciones Detalle, Sucursal</small>
                          </h1>
                          <ol class="breadcrumb">
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros" style="height: 800px;">
                        ...
                        <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <button class="btn btn-success" onclick="listarxfechasucursalDetalle()">Mostrar x fecha y sucursal</button>   
                        </div>   
