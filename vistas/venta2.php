                        ...
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                              ...
                              <h1 id="total" class="text-success">Q. 0.00</h1> <!-- Verde -->
                            </div> 

                            <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                              <label>Valor Descuento:</label>
                              <h1 id="totaldes" class="text-danger">Q. 0.00</h1> <!-- Rojo -->
                            </div>                                                                                                            
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: none;">
                              <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                <input type="text" class="form-control" name="codigo_ingresar" id="codigo_ingresar" maxlength="50" placeholder="codigo">
                              </div>
                              <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                <input type="hidden" name="idarticulo_ingreso" id="idarticulo_ingreso"><input type="text" class="form-control" name="articulo_ingresar" id="articulo_ingresar" readonly="">
                              </div> 
                              <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                <input  class="form-control"   type="number" step="any"  name="cantidad_ingreso" id="cantidad_ingreso">
                              </div>   
                              <div class="form-group col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                <input  class="form-control"   type="number" step="any"  name="precio_venta_ingreso" id="precio_venta_ingreso"  readonly="">
                              </div>                      
                            </div>                                                                                                                                                                                                                                               
                          </div>
                          ...
                          <div class="form-group col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <style>
                                ...
                                .custom-card {
                                  height: 250px; /* <--- antes tenías 320px */
                                  padding: 5px;
                                }
                                ...
                                @media (max-width: 992px) {
                                  ...
                                  .articulo-card {
                                    ...
                                    .contenedor-articulos-scroll {
                                      height: 500px; /* o lo que tú consideres visible */
                                      overflow-y: auto;
                                      padding: 10px;
                              ...
                              <style>
                                .categoria-scroll {
                                  ...
                                  padding: 10px 0;        /* 🔹 Margen vertical */
                                  scrollbar-width: thin;  /* 🔹 Mantiene scroll fino si hay overflow */
                                }
                                ...
                                .categoria-scroll button {
                                  ...
                                  border-radius: 25px;        /* Bordes redondeados tipo chip */
                                  font-weight: 600;           /* Letras más gruesas */
                                  text-transform: uppercase;  /* Texto en mayúsculas */
                                  transition: all 0.2s ease;
                                  flex-shrink: 0;             /* 🔹 Evita que se aplasten al hacer wrap */
                                }
                            ...
                            <div class="modal-dialog" style="width: 70% !important;">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <style>
                                      .input-grande {
                                        font-size: 40px;           /* Tamaño grande del número dentro del input */
                                        height: 60px;              /* Altura del input para hacerlo más visible */
                                        text-align: right;         /* Alinea los números a la derecha (como calculadora) */
                                        padding-right: 10px;       /* Espacio interno a la derecha */
                                        margin-bottom: 15px;       /* Espacio debajo del input */
                                        width: 200px;              /* ← NUEVO: ancho personalizado */
                                      }
                                      .calculadora {
                                        display: grid;
                                      ...
                                      <div class="box box-success box-solid collapsed-box">
                                        ...
                                        <div class="box-body" style="display: none;">
                                          ...
                                          <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            onfocus="setInputActivo('numero_pagos')" onchange="calculo();">
                                          </div>  
                                          <div class="form-group col-lg-6 col-md-12 col-sm-12 col-xs-12">
         ...
         <div class="col-lg-812 col-sm-12 col-md-812 col-xs-12 table-responsive">
          <form name="formulariocierre" id="formulariocierre" method="POST">
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <label>Total de Gastos a Ventas en Efectivo:</label>
                              <input type="number" step="any"class="form-control" onchange="calcularcaja()" name="total_ventas_gastosEfectivo" id="total_ventas_gastosEfectivo" value="<?php echo $restotalgastoventa; ?>" readonly="" >
                            </div>    

                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <label>Total de Abonos a Ventas:</label>
                              <input type="number" step="any"class="form-control" onchange="calcularcaja()" name="total_ventas_AbonosVentas" id="total_ventas_AbonosVentas" value="<?php echo $restotatalAbonoctacobrar; ?>" readonly="" >
                            </div>  
 
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <label>Total de NC a Ventas:</label>
                              <input type="number" step="any"class="form-control" onchange="calcularcaja()" name="total_ventas_NCVentas" id="total_ventas_NCVentas" value="<?php echo $restotalNCventa; ?>" readonly="" >
                            </div>                                                                                                                                                                                                                                                                                       
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="modal-body">
        <form name="formulariogastoventa" id="formulariogastoventa" method="POST">
            ...
            <div class="form-group">
              ...
              <center><div id='dataresponse' class="text-primary text-center"></div></center><br>
            </div>
