        ...
        switch ($_GET["op"]) {
            case 'guardaryeditar':
                ...
                if (empty($idtraladosucursal)) {
                    $rspta = $salidaprosucursal->insertar($idusuario_salida, $descripcion_salida_producto, $tipo_operacion, $datosArticulos);
                    echo $rspta;
                }
                break;
            ...
            case 'listar':
                ...
                while ($reg = $rspta->fetch_object()) {
                    ...
                    $data[] = array(
                        ...
                        "3" => $reg->us_salida,
                        "4" => $reg->us_creacion,
                        "5" => $reg->observacion_credito . " Tipo Operacion: " . $reg->tipo_operacion,
